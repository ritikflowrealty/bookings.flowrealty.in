 ...
 * recruiting nudge). Visual language matches the rest of the site: glass
 * card, neon halo accents, uppercase heading.
 */
export function JoinFlowCta({
  ...
  // Highlight the literal word "flow" in the title with the brand gradient,
  // case-insensitively. Falls back to plain text if the word isn't present.
  const titleParts = title.split(/(flow)/i);
